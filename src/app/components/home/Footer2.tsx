...
export default function Footer2() {
  ...
  return (
    <footer className="bg-[#1C1C1C] text-white pt-12 ">
      ...
      <hr className='border-b-[1px] border-[#FFFFFF]'/>

<div className="flex max-w-[1300px] mx-auto text-left py-7  sm:flex-row justify-between items-center gap-4 text-gray-400 md:text-sm text-[8px]">
