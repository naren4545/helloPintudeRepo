...
<div className="py-7 pt-10">
              <a href="https://signupzai.com/signup" id="signup-button" data-umami-event="Signup button" target="_blank" className="text-white  py-4 px-4 rounded-[57px] mx-auto text-sm md:text-2xl bg-[#FF5E62]">अभी रजिस्टर करें</a>
              </div>
            </div>
