    ...
    <div className="bg-[#F8F9DE] px-4 md:px-6 py-10 md:py-12">
      <div className="max-w-[1300px] mx-auto">
        <div className="text-center  py-10">
          <h2 className="text-sm md:text-[48px] font-bold mb-3 md:mb-4">
        ...
        <div className="grid grid-cols-2 gap-3 md:gap-8">
          ...
          <div className=" flex  items-center gap-4 w-full max-w-[830px] mx-auto py-10  p-4">
            <div className="mr-4">
              <Image
                src={img}
...
टूल्स के साथ किफायती मूल्य।.
          ...
          <div className="flex md:flex-row flex-col gap-4 items-center bg-white rounded-lg shadow-md py-10 p-4">
          ...
          <div className="flex items-center gap-4 md:flex-row flex-col bg-white rounded-lg shadow-md py-10 p-4">
            <div className="md:mr-4">
              <Image
                src={showCase}
                alt="Connect Icon"
